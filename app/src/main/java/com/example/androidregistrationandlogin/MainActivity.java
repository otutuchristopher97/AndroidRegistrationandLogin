...
public class MainActivity extends AppCompatActivity {
    ...
    private static String URl_REGIST = "http://datamine2u.000webhostapp.com/register.php";
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, URl_REGIST,
                new Response.Listener<String>() {
                    ...
                    try {
                        ...
                        e.printStackTrace();
                        Toast.makeText(MainActivity.this, "Register Error! " + e.toString(), Toast.LENGTH_SHORT);
